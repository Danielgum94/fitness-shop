    ...
    <div className="terms-container p-2">
      ...
      <div className="terms-content">
        <p>
          ...
          <br />
          This website is operated by SDG ALLINONE. Throughout the site, the terms "we," "us," and "our" refer to SDG ALLINONE. SDG ALLINONE offers this website, including all information, tools, and services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies, and notices stated here.
          By visiting our site and/or purchasing something from us, you engage in our "Service" and agree to be bound by the following terms and conditions ("Terms of Service," "Terms"), including those additional terms and conditions and policies referenced herein and/or available by hyperlink. These Terms of Service apply to all users of the site, including without limitation users who are browsers, vendors, customers, merchants, and/or contributors of content.
          </p>
        <p>
          Please read and understand these Terms of Service carefully before accessing or using our website. By accessing or using any part of the site, you agree to be bound by these Terms of Service. If you do not agree to all the terms and conditions of this agreement, then you may not access the website or use any services. If these Terms of Service are considered an offer, acceptance is expressly limited to these Terms of Service.
        </p>
        <p>
        ...
        <h2 className="terms-section">SECTION 1 - ONLINE STORE TERMS</h2>
        <p>
        ...
        <h2 className="terms-section">SECTION 2 - GENERAL CONDITIONS</h2>
        <p>
        ...
        <h2 className="terms-section">SECTION 3 - ACCURACY, COMPLETENESS AND TIMELINESS OF INFORMATION</h2>
        <p>
        ...
        <h2 className="terms-section">SECTION 4 - MODIFICATIONS TO THE SERVICE AND PRICES</h2>
        <p>
        ...
        <h2 className="terms-section">SECTION 5 - PRODUCTS OR SERVICES (if applicable)</h2>
        ...
        <h2 className="terms-section">SECTION 6 - ACCURACY OF BILLING AND ACCOUNT INFORMATION</h2>
